...
public final class ItemMessageIncomingBinding implements ViewBinding {
  ...
  private ItemMessageIncomingBinding(@NonNull LinearLayout rootView, @NonNull TextView messageText,
  ...
  public static ItemMessageIncomingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageIncomingBinding((LinearLayout) rootView, messageText, messageTime);
    }

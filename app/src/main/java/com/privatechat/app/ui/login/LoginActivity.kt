...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton.setOnClickListener {
            ...
            FirebaseDatabase.getInstance("https://private-chat-318a6-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("users").child(username)
    ...
    private fun registerFcmToken(username: String) {
        FirebaseMessaging.getInstance().token.addOnSuccessListener { token ->
            FirebaseDatabase.getInstance("https://private-chat-318a6-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("fcmTokens").child(username).setValue(token)
        }
    }
